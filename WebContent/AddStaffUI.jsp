		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb blue-grey lighten-4">
				<li class="breadcrumb-item"><a class="black-text"
					href="staffmanagement">Staff Summary</a><i
					class="fas fa-angle-double-right mx-2" aria-hidden="true"></i></li>
				<li class="breadcrumb-item active"><a class="black-text">Add
						New Staff</a>
			</ol>
		</nav>
	</div>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
						<a href="staffmanagement" class="list-group-item ">Staff
							Summary</a> <a href="addStaff" class="list-group-item active">Add
							New Staff</a>
					</div>
				</div>
				<div class="col-md-9">
						...
						<div class="list-group-item">
							<form class="form-group" action="addstaff" method="POST">
								<label>Job Title</label> <select class="form-control"
									name="jobSelect" id="jobSelect" onChange="return setPin()">
								...
								</select><br> <label>First Name</label> <input class="form-control"
									type="text" name="fName"><br> <label>Last
									Name</label> <input class="form-control" type="text" name="lName"><br>
								<label>PIN</label> <input class="form-control" type="text"
									name="pin" id="pin" readonly><br> <label>Phone</label>
								<input class="form-control" type="tel" id="example-tel-input"
									name="contactNum"><br>

								<button type="reset" class="btn btn-secondary">Clear</button>
								<input type="submit" value="Add" class="btn btn-primary"
									data-toggle="modal" data-target="#addModal"> <input
									type="hidden" value="addConfirm" name="addbtnConfirm">
							</form>
						</div>
	...
	<div class="modal fade" id="addModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">{Added Staff info} has been added!</div>
